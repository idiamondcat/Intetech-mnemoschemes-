register("separator-big-elem", class extends SimpleElement {
            ...
            <div class="separator-body">
                ...
                <div class="right-overlay">
					<div class="separator-h-level-container">
						<div class="mid-overlay">
							<div class="bot-overlay">
								<level-for-barrels-elem class="separator-h-level" _sadditionallines="2" _sorient="0" id="3"></level-for-barrels-elem>
							</div>
						</div>
					</div>
					<div class="water-pump-container">
						<div class="mid-overlay">
							<div class="bot-overlay">
								<container-water-pump-elem class="separator-water-pump" id="4"></container-water-pump-elem>
							</div>
						</div>
					</div>
                </div>
	...
	static get style() {
        ...
        .separator-big-elem .cap svg {
            height: 100%;
        }
        .separator-big-elem .cap svg path {
            fill: var(--barrels-fill);
        }
		.separator-big-elem .cap svg rect {
			fill: var(--barrels-fill);
            stroke: var(--body-bg-color);
			stroke-miterlimit: 10;
			stroke-width: 1.5;
        }
        .separator-big-elem .separator-body {
            height: 98%;
            flex-grow: 1;
			display: flex;
		...
		.separator-big-elem .separator-body .left-overlay.visible,
		.separator-big-elem .separator-body .right-overlay.visible {
			display: flex;
		}
		.separator-big-elem .separator-body .left-overlay.visible.level,
		.separator-big-elem .separator-body .right-overlay.visible.level {
			height: 61.7%;
		}
		.separator-big-elem .separator-body .left-overlay.visible.pump,
		.separator-big-elem .separator-body .right-overlay.visible.pump {
			height: 61.7%;
		}
		.separator-big-elem .separator-body .left-overlay.invisible,
		.separator-big-elem .separator-body .right-overlay.invisible {
			display: none;
		}
		.separator-big-elem .separator-body .left-overlay .separator-h-level-container,
		.separator-big-elem .separator-body .right-overlay .separator-h-level-container {
			display: none;
		}
		.separator-big-elem .separator-body .left-overlay .separator-h-level-container.active,
		.separator-big-elem .separator-body .right-overlay .separator-h-level-container.active {
			display: block;
			width: 100%;
			height: 100%;
		...
		.separator-big-elem .separator-body .left-overlay .separator-h-level-container .mid-overlay,
		.separator-big-elem .separator-body .right-overlay .separator-h-level-container .mid-overlay {
			display: block;
			width: 100%;
			height: 100%;
			background-color: #f5f5f8;
		}
		.separator-big-elem .separator-body .left-overlay .separator-h-level-container .mid-overlay .bot-overlay,
		.separator-big-elem .separator-body .right-overlay .separator-h-level-container .mid-overlay .bot-overlay {
			display: block;
			width: 100%;
			height: 100%;
		...
		.separator-big-elem .separator-body .left-overlay .separator-h-level-container .mid-overlay .bot-overlay .separator-h-level,
		.separator-big-elem .separator-body .right-overlay .separator-h-level-container .mid-overlay .bot-overlay .separator-h-level {
			height: 100%;
			width: 100%;
			position: absolute;
			top: 0;
		...
		.separator-big-elem .separator-body .left-overlay .water-pump-container,
		.separator-big-elem .separator-body .right-overlay .water-pump-container {
			display: none;
		}
		.separator-big-elem .separator-body .left-overlay .water-pump-container.active,
		.separator-big-elem .separator-body .right-overlay .water-pump-container.active {
			display: block;
			width: 100%;
			height: 100%;
			background-color: #7fafae;
		...
		.separator-big-elem .separator-body .left-overlay .water-pump-container .mid-overlay,
		.separator-big-elem .separator-body .right-overlay .water-pump-container .mid-overlay {
			display: block;
			width: 100%;
			height: 100%;
			background-color: #f5f5f8;
		}
		.separator-big-elem .separator-body .left-overlay .water-pump-container .mid-overlay .bot-overlay,
		.separator-big-elem .separator-body .right-overlay .water-pump-container .mid-overlay .bot-overlay {
			display: block;
			width: 100%;
			height: 100%;
			background-color: rgba(127, 175, 174, 0.3);
		...
		.separator-big-elem .separator-body .center-block {
			width: 44.8%;
			height: 100%;
			display: flex;
		...
		.separator-big-elem .separator-body .center-block .naming-container {
			width: 100%;
			position: absolute;
			top: -23px;
			left: 0;
		...
		.separator-big-elem .separator-body .center-block .naming-container .naming {
			display: block;
			text-align: center;
		...
		.separator-big-elem .separator-body .center-block .separator-h-multi-tit {
			width: 100%;
			height: 100%;
		}
		`;
	...
	static get observedAttributes() {
		return ['_sleftblock', '_sleftblockcontent', '_srightblock', '_srightblockcontent', '_scaption', '_sfontsize', '_stitcount', '_sleftpumpcaption', '_srightpumpcaption'];
	}
	...
	onUpdateStatic = function() {
		let ElemCont = this.shadowRoot.querySelector('.separator-big-elem');
	...
	Init = function() {
		let theElemCont = this.shadowRoot.querySelector('.separator-big-elem');
